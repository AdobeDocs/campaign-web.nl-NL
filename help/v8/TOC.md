...
+ Inhoudsbeheer {#content}
   + Dynamische inhoud maken {#dynamic-content}
      + [Hoe kan ik uw inhoud dynamisch maken?](personalization/gs-personalization.md)
   ...
   + E-mails ontwerpen {#email-design}
      ...
      + Stijl uw inhoud {#style}
         ...
         + [Inhoud in de donkere modus beheren](email/dark-mode.md)
      + [Toegankelijke inhoud maken](email/accessible-content.md)
   + AI-assistent {#ai-assistant}
      + [Werken met AI-assistent](content/generative-gs.md)
      + [Tips en trucs voor AI](content/ai-assistant-prompting-guide.md)
      + [Volledige inhoud genereren met AI](content/generative-full-content.md)
      + [Tekst genereren met AI](content/generative-text.md)
      + [Afbeelding genereren met AI](content/generative-image.md)
...
+ Profielen en publiek {#audiences}
   ...
   + Ontvangers selecteren {#target-audiences}
      ...
      + [Een overvulgroep toevoegen](audience/trap-group.md)
...
+ Configuratie {#conf}
   ...
   + Werken met schema&#39;s {#schemas}
      + [Over schema&#39;s](administration/schemas.md)
      + [Toegang tot en vorm schema&#39;s](administration/schemas-browse-access.md)
      + [Lijstkolommen configureren](administration/schemas-list-columns.md)
      + [Aangepaste velden bewerken](administration/schemas-custom-fields.md)
      + [Verzamelingslijsten toevoegen](administration/schemas-collection-lists.md)
      + [Schema&#39;s maken en publiceren](administration/schemas-create-publish.md)
      + [Werken met aangepaste formulieren](administration/schemas-custom-forms.md)
