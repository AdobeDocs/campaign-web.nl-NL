...
| **[!UICONTROL Sticky]** | Wanneer deze optie is geactiveerd, blijft de melding zichtbaar, zelfs nadat de gebruiker erop heeft geklikt. <br> als gedeactiveerd, wordt het bericht automatisch verworpen wanneer de gebruiker met het in wisselwerking staat. Dankzij het plakgedrag blijven belangrijke meldingen langer op het scherm staan. |
