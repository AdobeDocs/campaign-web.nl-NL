...
![ Schermafbeelding die de homepage met eigenschapkaarten en navigatieopties tonen ](assets/home.png){zoomable="yes"}
...
![ Schermschot die de Ongeveer verbinding bij de bodem van de pagina tonen ](assets/about-link.png){zoomable="yes"}
...
![ Schermschot die de Geïnstalleerde pakketsectie met onderzoeksfunctionaliteit tonen ](assets/about.png){zoomable="yes"}
...
* **Leveringen** - doorblader door uw lijst van leveringen. Standaard kunt u hun status, laatste wijzigingsdatum en sleutel-KPI&#39;s weergeven. U kunt de lijst filteren op status, contactdatum of kanaal. Klik op een e-maillevering om het dashboard te openen voor een overzicht van de leveringsgegevens. Leveringen op andere kanalen zijn alleen-lezen. Leer meer over leveringen [ in deze sectie ](../msg/gs-messages.md).
  ...
  ![](assets/more-actions.png){zoomable="yes"}{width="70%" align="left"} [ Schermafbeelding die de Meer actieknop met opties toont om een levering te schrappen of te dupliceren.]
...
* **Schema&#39;s** - de gebieden van de Douane zijn extra attributen die aan uit-van-de-doosschema&#39;s door de console van Adobe Campaign worden toegevoegd. [Meer informatie](../administration/schemas-custom-fields.md).
