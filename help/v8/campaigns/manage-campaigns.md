...
Als u uw campagnes wilt openen en beheren, klikt u op het menu **[!UICONTROL Campaigns]** links in de navigatie. Er zijn twee tabbladen beschikbaar:
...
## Overzicht van campagnes {#inventory}

Het tabblad **[!UICONTROL Browse]** bevat informatie over de huidige status van de campagnes, de begin- en einddatum, de aanmaakdatum, de laatste keer dat ze zijn gewijzigd, enzovoort. U kunt de getoonde kolommen aanpassen door **te klikken vormt kolom voor een pictogram van de douanelay-out** dat in de hoger-juiste hoek van de lijst wordt gevestigd. Op deze manier kunt u kolommen toevoegen of verwijderen en gegevens opnieuw ordenen in de campagnemelijst.

### De voorraad zoeken en filteren {#search-and-filter}

Er zijn een zoekbalk en filters beschikbaar waarmee u gemakkelijk in de lijst kunt zoeken. [Meer informatie](../get-started/user-interface.md#list-screens). U kunt bijvoorbeeld filteren op uw campagneprogramma. Open het filterpaneel en gebruik **Begin - de sectie van de Datum van het Eind**:
...
### Tijdlijnweergave {#timeline}

Door gebrek, toont het campagnescherm de **mening van de Lijst** (inventaris). U kunt op **mening van de Chronologie** op elk ogenblik schakelen gebruikend de meningsknevel. In beide weergaven worden dezelfde campagnes getoond en worden dezelfde filters en zoekopdrachten gebruikt. Wanneer u filters wijzigt of in de ene weergave zoekt, weerspiegelt de andere weergave dezelfde selectie.

In de tijdlijnweergave kunt u uw campagnes in de loop van de tijd visualiseren en beheren. U kunt al uw campagnes in een op tijd-gebaseerd formaat zien, makend het gemakkelijker om, uw marketing activiteiten te plannen te plannen en te coördineren.

![](assets/timeline-view.png)

**hoe de chronologie werkt:**

* In de tijdlijn worden uw campagnes weergegeven op basis van hun begin- en einddatum. Campagnes die meerdere dagen beslaan, worden op de desbetreffende datums weergegeven.
* U kunt per week, maand, of dag navigeren. Gebruik de datumkiezer of de pijlknoppen om tussen punten te navigeren. Gebruik **vandaag** knoop om snel aan de huidige datum terug te keren.
* Als u een campagne selecteert, wordt er een rechterpaneel geopend met campagnedetails: status, begin- en einddatum, lijst met workflows en lijst met leveringen. U kunt vanuit het deelvenster naar deze workflows en leveringen navigeren.
* Bezig met de prioritering van campagnes in de weergave wanneer veel campagnes op dezelfde datum plaatsvinden.
* Wanneer vele campagnes op één enkele dag (bijvoorbeeld in maandmening) vallen, laat de a **Meer** controle u uitbreiden om de volledige reeks voor die dag te zien, of schakelaar aan week of dagmening voor meer detail.
