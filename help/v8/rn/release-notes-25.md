...
* U kunt nu verzamelingskoppelingen, zoals aankopen, selecteren in de schermdefinitie van het schema Ontvangers. Hiermee worden de gerelateerde gegevens op profielschermen weergegeven via een speciaal tabblad. <!-- [Learn more](../administration/schemas.md)-->
...
* U kunt nu de aangepaste velden van een schema voorvertonen in een voorbeeldscherm. Raadpleeg de [gedetailleerde documentatie](../administration/schemas-custom-fields.md) voor meer informatie.
* U kunt nu aangepaste velden in de lijst verplaatsen door ze te slepen en neer te zetten. Raadpleeg de [gedetailleerde documentatie](../administration/schemas-custom-fields.md) voor meer informatie.
