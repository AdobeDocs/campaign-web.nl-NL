...
* Wanneer uw de plaatsingsmodel van de Campagne [ Volledige Verbond van de Onderneming van Adobe Campaign Toegang (FFDA) ](https://experienceleague.adobe.com/nl/docs/campaign/campaign-v8/config/architecture/ffda/enterprise-deployment){target="_blank"}  is
