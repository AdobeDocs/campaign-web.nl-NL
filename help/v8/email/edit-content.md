...
1. Nadat de inhoud van uw e-mail is gedefinieerd, controleert u met de knop **[!UICONTROL Simulate content]** hoe het bericht wordt weergegeven voordat u het verzendt. U kunt ook de kwaliteit van uw inhoud valideren om de leesbaarheid, de CTA-effectiviteit en de algehele kwaliteit te beoordelen. [ leer meer over de bevestiging van de inhoudskwaliteit ](../content/brands-score.md#validate-quality)

1. [ Leer hoe te om uw e-mail ](../preview-test/preview-test.md) voor te vertonen en te testen.
