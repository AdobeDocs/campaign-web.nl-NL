...
1. Klik op **[!UICONTROL Edit content]** nadat u de e-maillevering hebt gemaakt en geconfigureerd.
   ...
   Voor meer informatie bij het vormen van uw e-maillevering, verwijs naar [ deze pagina ](../email/create-email-content.md).
...
1. Schakel **[!UICONTROL Subject line]** of **[!UICONTROL Preheader]** in of uit om deze op te nemen in het genereren van varianten.
...
1. Wanneer u uw inhoud, publiek en planning definieert, moet u de e-maillevering voorbereiden. [Meer informatie](../monitor/prepare-send.md)
