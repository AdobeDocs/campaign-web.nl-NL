...
>title="Inhoud experimenteren"
>abstract="Met contentexperimenten kunt u meerdere leveringsvarianten voor A/B-tests definiëren om te meten welke het beste voor het doelpubliek presteert. U kunt de leveringsinhoud, het onderwerp, of de afzender variëren om verschillende versies te testen en te bepalen welke variant de beste resultaten veroorzaakt."
