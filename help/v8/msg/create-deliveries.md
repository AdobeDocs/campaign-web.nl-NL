...
>abstract="Selecteer de velden voor profielverrijking. Alleen velden met een index kunnen worden geselecteerd als afstemmingssleutels. Niet-ondersteunde velden worden grijs weergegeven."
...
* Het opnemen van dynamische **verpersoonlijkingsgebieden**
  ...
  De gebieden van de verpersoonlijking worden gebruikt voor verpersoonlijking op het eerste niveau van uw berichten. U kunt om het even welk gebied selecteren beschikbaar in het gegevensbestand van de verpersoonlijkingsredacteur. Voor een levering, kunt u om het even welk gebied selecteren met betrekking tot de ontvanger, het bericht, of de levering. Deze verpersoonlijkingsattributen kunnen in de onderwerpregel of het lichaam van uw berichten worden opgenomen. [&#x200B; Leer meer &#x200B;](../personalization/personalize.md)
...
* Creërend **voorwaardelijke inhoud**
  ...
  Configureer voorwaardelijke inhoud om bijvoorbeeld dynamische personalisatie toe te voegen op basis van het profiel van de ontvanger. Tekstblokken en/of afbeeldingen worden ingevoegd wanneer een bepaalde voorwaarde waar is. [&#x200B; Leer meer &#x200B;](../personalization/conditions.md)

* Het toevoegen van **gepersonaliseerde aanbiedingen**

  Voeg persoonlijke aanbiedingen in uw berichtinhoud in, afhankelijk van de locatie van de ontvanger, het huidige weer of de laatste kooporder. [&#x200B; Leer meer &#x200B;](../msg/offers.md)

## Geef een voorvertoning van uw leveringen weer en test deze

Nadat de inhoud van uw bericht is gedefinieerd, kunt u deze voorvertonen om de weergave van uw berichten te beheren en de instellingen voor de personalisatie te controleren met testprofielen. [&#x200B; Leer meer &#x200B;](../preview-test/preview-test.md)
...
Voer de volgende stappen uit om de verzending van een levering te plannen:

1. Open de levering en blader naar de sectie **[!UICONTROL Schedule]** .
1. Activeer de schakeloptie **[!UICONTROL Enable scheduling]** .
1. Klik in het veld **[!UICONTROL Contact date]** op het kalenderpictogram en stel de gewenste datum en tijd voor verzending in.
1. Selecteer in het veld **[!UICONTROL Time zone]** de gewenste tijdzone in het keuzemenu.
...
Standaard is de optie **[!UICONTROL Enable confirmation before sending]** ingeschakeld. Voor deze optie moet u de verzending bevestigen voordat de levering op de geplande datum wordt verzonden en als u de levering automatisch op de geplande datum en tijd moet verzenden, kunt u deze optie.me uitschakelen.
