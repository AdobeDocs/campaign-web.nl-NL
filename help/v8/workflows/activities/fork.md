...
U kunt een afzonderlijke tak ook tot stand brengen gebruikend **vertakking** toevoegen (**+**) toolbarknoop. Zie [&#x200B; Orchestrate activiteiten &#x200B;](../orchestrate-activities.md#toolbar).
