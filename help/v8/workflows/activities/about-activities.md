...
>title="Eindactiviteit"
>abstract="De **activiteit van het Begin** staat u toe om het begin van een werkschema grafisch te merken. Deze activiteit heeft geen functioneel effect en is daarom optioneel."

>[!CONTEXTUALHELP]
>id="acw_orchestration_signal"
>title="Extern signaal"
>abstract="tijdelijke aanduiding voor de externe signaalsectie in de parameters voor eindactiviteit. Alleen beschikbaar voor georkestreerde campagnes. NIET DELETE"
...
* [ sluit zich aan ](join.md): Synchroniseer veelvoudige uitvoertakken van een werkschema.
* [ Planner ](scheduler.md): Plan wanneer het werkschema begint.
* **Begin** en **Eind**: Merk grafisch het begin en het eind van een werkschema. Zij zijn facultatief en hebben geen enkel functioneel effect.

  >[!NOTE]
  >
  >Merk op dat de **activiteit van het Begin** automatisch aan alle die werkschema&#39;s wordt toegevoegd vóór de 26.3 versie worden gecreeerd. Deze wordt standaard niet ingevoegd in nieuwe workflows.
